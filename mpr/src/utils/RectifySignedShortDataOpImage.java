...
public final class RectifySignedShortDataOpImage extends ColormapOpImage {
	...
	/**
	 * Transform the colormap according to the rescaling parameters. Should
	 ...
	 *
	 * @param sources
	 *            Cobbled sources, guaranteed to provide all the source data
	...
	public Vector<RenderedImage> getSources(){
		Vector<?> sources = super.getSources(); 		
		return sources == null ? null : new Vector<>(sources.stream().map(o -> RenderedImage.class.cast(o)).collect(Collectors.toList()));
	}
}
